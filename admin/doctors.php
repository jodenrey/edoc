            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                  <input type="tel" name="Tele" class="input-text" placeholder="Telephone Number" required maxlength="11" pattern="[0-9]{11}" title="Telephone number must be exactly 11 digits">
<br>
                                </td>
                            </tr>
                            <tr>
       ...
       title="Telephone number must be exactly 11 digits (numbers only)">
<br>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        ...
                                        <td class="label-td" colspan="2">
                                            <label for="cpassword" class="form-label">Confi rm Password: </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
